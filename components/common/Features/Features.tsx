import { dataFeautures } from "./Feautures.data";
import Reveal from "../Reveal/Reveal";

export default function Features() {
  return (
    <div className="max-w-6xl mx-auto p-6 lg:py-40">
      <h3 className="text-2xl lg:text-6xl font-bold">Key Feautures</h3>
      <p className="max-w-lg mt-5 lg:mt-10 lg:mb-16 text-xl">
        We are about clients conform and safety. That's why we provide the best
        service you can imagine
      </p>
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-x-5 ">
        {dataFeautures.map(({ bg, delay, icon: Icon, text }) => (
          <Reveal
            key={text}
